...
namespace UnitTestsGeneratorLibrary.Tests
{
    public class Tests
    {
        ...
        private const string ClassAFullPath = @"D:\Projects\SPP\UnitTestsGenerator\SampleLibrary\ClassA.cs";
        private const string ClassBFullPath = @"D:\Projects\SPP\UnitTestsGenerator\SampleLibrary\ClassB.cs";

        private const string EndpointTestFolder = @"D:\Projects\SPP\UnitTestsGenerator\SampleLibrary.Tests\";
